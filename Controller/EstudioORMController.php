...
// datos (insert)
        ...
        return $this->render('JAMNotasFrontendBundle:EstudioORM:crear.html.twig', array('notas' => $notas));
    }
    ...
    public function recuperarAction()
    {
        ...
        return $this->render('JAMNotasFrontendBundle:EstudioORM:recuperar.html.twig', array('nota' => $nota));
    }
    ...
    public function recuperarNotasAction()
    {
        ...
        return $this->render('JAMNotasFrontendBundle:EstudioORM:recuperarNotas.html.twig', array('notas' => $notas));
    }
    ...
    function dqlAction()
    {
        ...
        return $this->render('JAMNotasFrontendBundle:EstudioORM:recuperarNotas.html.twig', array('notas' => $notasAlberto));
    }
